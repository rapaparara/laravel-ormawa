    ...
    <footer class="mt-4 bg-white text-indigo-800">
        <div class="w-full max-w-screen-xl mx-auto p-4 md:py-8">
            <div class="sm:flex sm:items-center sm:justify-between">
                <a wire:navigate href="{{ route('home') }}" class="flex items-center mb-4 sm:mb-0 space-x-3 rtl:space-x-reverse">
                ...
                <ul
                    ...
                    <li>
                        <a wire:navigate href="{{ route('home.fasilitas') }}" class="hover:underline me-4 md:me-6">Fasilitas</a>
                    </li>
                    <li>
