    ...
    <div class="">
        ...
        <div class="mx-6 mt-4 p-5 bg-gray-50 text-gray-800 border border-gray-200 rounded-lg shadow-sm">
            <div class="flex flex-wrap">
                <h5 class="mb-2 text-2xl font-bold tracking-tight text-indigo-800 dark:text-white">Manajemen fakultas
                </h5>
            ...
            <div class="mt-3 relative overflow-x-auto">
                ...
                <div class="mt-3">
                    <div class="livewire-pagination"> {{ $dataFakultas->links() }}</div>
                </div>
            </div>
        </div>
    </div>
