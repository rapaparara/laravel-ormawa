            ...
            <section class="bg-gray-50">
                <div class="py-8 px-4 mx-auto max-w-screen-xl  text-center lg:py-16">
                    <h1
                        ...
                        Selamat datang Kemahasiswaan!</h1>
                    <p class="mb-3 text-lg font-normal text-gray-500 lg:text-xl sm:px-16 lg:px-48">
                        "Jadilah garda terdepan dalam menciptakan lingkungan yang inklusif dan penuh semangat. Dengan
                        kolaborasi dan dedikasi, mari wujudkan potensi tak terbatas kita bersama. Setiap langkah
                        membentuk jejak kejayaan, setiap perjuangan mengukir sejarah kebangkitan."</p>
