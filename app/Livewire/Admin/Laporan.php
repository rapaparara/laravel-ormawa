...
class Laporan extends Component
{
    ...
    protected function getKeaktifanOrmawaByPeriode($periode_id)
    {
        ...
        if ($periode_id !== null) {
            ...
            $totalPengurus = ModelsPengurus::join('periode_kepengurusans', 'penguruses.kepengurusan_id', '=', 'periode_kepengurusans.id')->join('ormawas', 'periode_kepengurusans.ormawa_id', '=', 'ormawas.id')->where('periode_kepengurusans.periode_id', $periode_id)->selectRaw('COUNT(*) AS jumlah, ormawa_id')->groupBy('ormawa_id')->get()->keyBy('ormawa_id');
            ...
            $totalKegiatan = ModelsKegiatan::selectRaw('COUNT(*) AS jumlah, kegiatans.ormawa_id')
                ...
                ->join(DB::raw("(SELECT id, name FROM ormawas ) as filtered_ormawas"), function ($join) {
        ...
        $dataOrmawa = ModelsOrmawa::get()->keyBy('id');
    ...
    protected function getKeaktifanOrmawa()
    {
        ...
        $totalPengurus = ModelsPengurus::join('periode_kepengurusans', 'penguruses.kepengurusan_id', '=', 'periode_kepengurusans.id')->join('ormawas', 'periode_kepengurusans.ormawa_id', '=', 'ormawas.id')->selectRaw('COUNT(*) AS jumlah, ormawa_id')->groupBy('ormawa_id')->get()->keyBy('ormawa_id');
    ...
    {
        $data = [];
        $data['dataOrmawa'] = ModelsOrmawa::get();
        // Data Kegiatan
        ...
        $data_peminjaman = ModelsPeminjaman::where('status', 'setujui')
        ...
        // Data Pengurus
        $data_pengurus = ModelsPengurus::join('periode_kepengurusans', 'penguruses.kepengurusan_id', '=', 'periode_kepengurusans.id')->join('ormawas', 'periode_kepengurusans.ormawa_id', '=', 'ormawas.id')->orderBy('ormawas.id')->get();
        $i = [];
    ...
    protected function getChartDataByPeriode($periode_id)
    {
        $data = [];
        $data['dataOrmawa'] = ModelsOrmawa::get();
        ...
        // Ambil data pengurus
        $data_pengurus = ModelsPengurus::join('periode_kepengurusans', 'penguruses.kepengurusan_id', '=', 'periode_kepengurusans.id')->join('ormawas', 'periode_kepengurusans.ormawa_id', '=', 'ormawas.id')->orderBy('ormawas.id')->selectRaw('COUNT(*) AS total_pengurus, ormawas.name AS ormawa_name')->groupBy('ormawas.name')->get();
    ...
    public function changeData()
    {
        ...
        if (isset($this->periode_id)) {
            if ($this->periode_id !== '') {
                $data['keaktifanOrmawa'] = $this->getKeaktifanOrmawaByPeriode( $this->periode_id);
            } else {
                $data['keaktifanOrmawa'] = $this->getKeaktifanOrmawa();
            }
        } else {
            $data['keaktifanOrmawa'] = $this->getKeaktifanOrmawa();
        }
        ...
        if (isset($this->periode_id)) {
            if ($this->periode_id !== '') {
                $data += $this->getChartDataByPeriode( $this->periode_id);
            } else {
